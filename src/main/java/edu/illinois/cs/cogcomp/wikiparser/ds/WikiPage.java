...
public class WikiPage implements java.io.Serializable {
    ...
    private Map<List<Integer>, String> hyperlinks;  // Internal wiki links in the page.  The first integer is the start and the second is the end char offset in the text field.  String is the link itself.
    ...
    public Map<List<Integer>, String> getHyperlinks(){
    ...
    public void setLinks(Map<List<Integer>, String> hyperlinks){
        this.hyperlinks = hyperlinks;
    }
    
    public void setWikiPageFields(String wikiTitle, String pageTitle, int curId, String text, Map<List<Integer>, String> hyperlinks){
        this.wikiTitle = wikiTitle;
        this.pageTitle = pageTitle;
        this.curId = curId;
        this.text = text;
